...
const Container = styled(motion.div)`
  max-width: 450px; /* Réduit de 600px à 450px */
  width: 100%;
  padding: 2rem; /* Réduit de 3rem à 2rem */
  background: rgba(255, 255, 255, 0.95);
  backdrop-filter: blur(12px);
  border-radius: 20px; /* Réduit de 30px à 20px */
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); /* Réduit l'ombre */
  ...
  &:hover {
    ...
    box-shadow: 0 15px 40px rgba(0, 0, 0, 0.2); /* Réduit l'ombre au survol */
  }
`;
...
const Title = styled(motion.h2)`
  ...
  text-shadow: 0 1px 10px rgba(45, 55, 72, 0.3); /* Réduit l'ombre */
...
const Input = styled(motion.input)`
  padding: 0.9rem; /* Réduit de 1.25rem à 0.9rem */
  border-radius: 10px; /* Réduit de 15px à 10px */
  border: 2px solid #e2e8f0;
  font-size: 1rem; /* Réduit de 1.1rem à 1rem */
  font-family: "Roboto", sans-serif;
  background: rgba(255, 255, 255, 0.9);
  box-shadow: inset 0 1px 6px rgba(0, 0, 0, 0.05); /* Réduit l'ombre */
  transition: all 0.3s ease;

  &:focus {
    border-color: #4a90e2;
    box-shadow: 0 0 0 4px rgba(74, 144, 226, 0.3); /* Réduit l'effet de focus */
    transform: scale(1.01); /* Réduit de 1.02 à 1.01 */
    outline: none;
  }
...
const Textarea = styled(motion.textarea)`
  ...
  background: rgba(255, 255, 255, 0.9);
  box-shadow: inset 0 1px 6px rgba(0, 0, 0, 0.05); /* Réduit l'ombre */
  min-height: 100px; /* Réduit de 140px à 100px */
  resize: vertical;
  transition: all 0.3s ease;
...
const DropZone = styled(motion.div)`
  border: 2px dashed ${({ dragActive }) => (dragActive ? "#4a90e2" : "#cbd5e1")}; /* Réduit de 3px à 2px */
  border-radius: 15px; /* Réduit de 20px à 15px */
...
const UploadButton = styled(motion.button)`
  padding: 0.6rem 1.5rem; /* Réduit de 0.8rem 2rem à 0.6rem 1.5rem */
  ...
  box-shadow: 0 3px 10px rgba(74, 144, 226, 0.4); /* Réduit l'ombre */
  transition: all 0.3s ease;
  position: relative;
  z-index: 1;
  ...
  &:hover {
    ...
    transform: translateY(-2px) scale(1.03); /* Réduit les effets */
...
const MediaImage = styled.img`
  width: 90px; /* Réduit de 120px à 90px */
  height: 90px; /* Réduit de 120px à 90px */
  object-fit: cover;
  border-radius: 10px; /* Réduit de 15px à 10px */
  box-shadow: 0 4px 15px rgba(0, 0, 0, 0.15); /* Réduit l'ombre */
  transition: all 0.3s ease;

  &:hover {
    transform: scale(1.1) rotate(2deg); /* Réduit de 1.15 à 1.1 */
    box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2); /* Réduit l'ombre */
  }
`;

const RemoveButton = styled(motion.button)`
  margin-top: 0.5rem; /* Réduit de 0.75rem à 0.5rem */
  padding: 0.5rem 1rem; /* Réduit de 0.6rem 1.5rem à 0.5rem 1rem */
  ...
  font-family: "Roboto", sans-serif;
  font-weight: 600;
  box-shadow: 0 3px 10px rgba(245, 101, 101, 0.4); /* Réduit l'ombre */
  transition: all 0.3s ease;
...
const CancelButton = styled(motion.button)`
  padding: 0.8rem 2rem; /* Réduit de 1rem 3rem à 0.8rem 2rem */
  ...
  font-weight: 600;
  font-size: 1rem; /* Réduit de 1.1rem à 1rem */
  box-shadow: 0 3px 10px rgba(160, 174, 192, 0.4); /* Réduit l'ombre */
  transition: all 0.3s ease;
...
const SubmitButton = styled(motion.button)`
  ...
  font-weight: 600;
  font-size: 1rem; /* Réduit de 1.1rem à 1rem */
  box-shadow: 0 3px 10px rgba(104, 211, 145, 0.4); /* Réduit l'ombre */
  transition: all 0.3s ease;
